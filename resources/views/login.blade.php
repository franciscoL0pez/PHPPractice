...
<div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-2xl">
    ...
    <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
        ...
        <div class="flex flex-col">
            <label for="email" class="text-sm font-semibold text-gray-700 mb-1">Correo electrónico</label>
        ...
        <!-- Password -->
        <div class="flex flex-col">
            <label for="password" class="text-sm font-semibold text-gray-700 mb-1">Contraseña</label>
